<template>
        ...
        <el-form :model="nameForm"
            ...
            <el-form-item required
                ...
                <el-input style="width: 200px"
                          v-model="nameForm.loginName"></el-input>
            </el-form-item>
            <el-form-item required
                          label="昵称："
                          prop="nickName">
                <el-input style="width: 200px"
                          v-model="nameForm.nickName"></el-input>
            </el-form-item>
            <el-form-item>
    ...
    <el-card class="account-container">
        <el-form :model="passForm"
            ...
            <el-form-item>
                <el-button type="danger"
                           @click="submitPass">确认修改</el-button>
            </el-form-item>
        </el-form>
    </el-card>
</template>
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            axios.get('/adminUser/info').then(res => {
                console.log("本账号数据",res)
                state.user=res
        ...
        const submitName=() => {
            nameRef.value.validate((vaild) => {
                if(vaild) {
                    axios.put('/adminUser/updatename',{
        ...
        const submitPass=() => {
            passRef.value.validate((vaild) => {
                if(vaild) {
                    axios.post('/adminUser/updatepassword',{
