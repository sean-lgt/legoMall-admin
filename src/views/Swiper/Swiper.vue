<template>
    <el-card class="swiper-container">
        ...
        <el-table v-loading="loading"
            ...
            <el-table-column prop="carouselRank"
                             label="排序值"
                             width="120">
            </el-table-column>
            ...
            <el-table-column label="操作"
                ...
                <template #default="scope">
                    <a style="cursor: pointer; margin-right: 10px"
                       @click="handleEdit(scope.row.carouselId)">修改</a>
...
export default {
    ...
    setup() {
        ...
        const handleAdd=() => {
            state.type='add';
            console.log("添加轮播项",addGood.value);
            // 
            addGood.value.open();
        }
        //修改轮播项
        ...
        const handleDelete=() => {
            if(!state.multipleSelection.length) {
                ElMessage.error("请选择后再进行删除操作");
                return;
            }
            axios.delete('/carousels/delete',{
                data: {
